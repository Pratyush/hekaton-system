...
mod glv_tests {
    ...
    use ark_ff::{PrimeField, UniformRand, BigInt};
    ...
    fn test_decompose_lambda_plus_1() {
        let s: G1ScalarField = Fr::from(BigInt([
            0x0000000100000000,
            0xac45a4010001a402,
            0x0000000000000000,
            0x0000000000000000,
    ...
    fn test_decompose_random() {
        ...
        .unwrap();
        if s.into_bigint().as_ref()[3] >= 0x3FFFFFFFF {
            ss = modulus - ss;
        }
    ...
    fn test_endo() {
        let mut rng = ark_std::test_rng();
        let lambda: G1ScalarField = Fr::from(BigInt([
            0x00000000ffffffff,
            0xac45a4010001a402,
            0x0000000000000000,
            0x0000000000000000,
