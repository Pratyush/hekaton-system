use ark_serialize::{CanonicalSerialize, CanonicalDeserialize, SerializationError, Compress, Valid, Validate};
...
pub struct GipaProof<E: Pairing> {
    pub num_proofs: u32,
    pub comms_ab: Vec<(Commitment<E>, Commitment<E>)>,
    pub comms_c: Vec<(Commitment<E>, Commitment<E>)>,
